...
function fetchProducts() {
    fetch('https://fedassignment-8d9a.restdb.io/rest/products', {
      ...
      headers: {
        ...
        'x-apikey': 'fc38ff8629540600a5d38d1c967c7de7faa9d',
      }
    })
    .then(response => {
  ...
  function createProductCard(product) {
    const cardContainer = document.getElementById('card-container'); // Your card container in HTML
  
    // Create elements for the card
    const card = document.createElement('div');
    card.className = 'product-card';
  
    const imageSource = "https://fedassignment-8d9a.restdb.io/media/" + product.Image;
    ...
    console.log(fetchImage(imageSource));
